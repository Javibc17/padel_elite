			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sketchy-1/14.png">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid ">
					...
					<div class="w-lg-600px bg-body rounded shadow-sm p-5 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" method="post" action="<?= base_url('signUp/store') ?>">
							<!--begin::Heading-->
							<div class="mb-10 text-center">
								...
								<a href="<?= base_url('signIn') ?>" class="link-primary fw-bolder">Iniciar Sesión</a></div>
								<!--end::Link-->
							</div>
							<!--end::Heading-->
							<!--begin::Action-->
							...
							<div class="row fv-row mb-7">
								...
								<div class="col-xl-6">
									...
									<input class="form-control form-control-lg form-control-solid" type="tel" placeholder="" name="telefono" autocomplete="off" pattern="\d{9}" title="El teléfono debe tener 9 números" />
								</div>
								<!--end::Col-->
							</div>
							<!--end::Input group-->
							...
							<div class="mb-10 fv-row" data-kt-password-meter="true">
								...
								<div class="mb-1">
									...
									<div class="position-relative mb-3">
										<input class="form-control form-control-lg form-control-solid" type="password" placeholder="" name="contraseña" autocomplete="off" />
