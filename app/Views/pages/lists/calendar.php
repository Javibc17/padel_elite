        ...
        if (calendarEl) {
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: function(fetchInfo, successCallback, failureCallback) {
                    $.ajax({
                        url: 'http://localhost/padel_elite/public/fetch-events',
                        method: 'GET',
                        dataType: 'json',
                ...
                select: function (info) {
                    ...
                    if (title) {
                        ...
                        $.ajax({
                            url: 'http://localhost/padel_elite/public/add-event',
                            method: 'POST',
                            data: eventData,
                            success: function() {
                ...
                eventClick: function (info) {
                    if (confirm('¿Deseas eliminar este evento?')) {
                        $.ajax({
                            url: 'http://localhost/padel_elite/public/delete-event/' + info.event.id,
                            method: 'DELETE',
                            success: function() {
                                calendar.refetchEvents();
                            },
