		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
				...
				<div class="aside-logo flex-column-auto" id="kt_aside_logo">
					<!--begin::Logo-->
					<a href="http://localhost/padel_elite/public/">
						<img alt="Logo" src="assets/media/logos/padel.svg" class="h-60px logo" />
					</a>
					<!--end::Logo-->
					<!--begin::Aside toggler-->
				...
				<div class="aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
							...
							<div class="menu-item">
								<a class="menu-link active" href="http://localhost/padel_elite/public/">
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title">Reservar</span>
								...
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<a class="menu-link" href="<?= base_url('pistas') ?>">
											...
											<span class="menu-title">Pistas</span>
										</a>
									</div>
									<div class="menu-item">
							...
							<div class="menu-item">
								<div class="menu-content pt-8 pb-2">
									<span class="menu-section text-muted text-uppercase fs-8 ls-1">Monitores</span>
								</div>
							</div>
							...
							<div class="card">
										...
										<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
											...
											<ul class="dropdown-menu">
												<li>
													...
													<form class="px-4 py-3" id="submenuJavi" method="GET"
														...
														<div class="mb-3">
															...
															<input type="text" class="form-control" id="filterName"
																name="filterName" value="<?= esc($filterName) ?>">
														</div>
														<div class="mb-3">
															<label for="filterEmail" class="form-label">Email</label>
															<input type="email" class="form-control" id="filterEmail"
																name="filterEmail" value="<?= esc($filterEmail) ?>">
														</div>
														<div class="mb-3">
															<label for="filterPhone" class="form-label">Teléfono</label>
															<input type="text" class="form-control" id="filterPhone"
																name="filterPhone" value="<?= esc($filterPhone) ?>">
														</div>
														<div class="mb-3">
															<label for="filterRole" class="form-label">Rol</label>
															<input type="text" class="form-control" id="filterRole"
																name="filterRole" value="<?= esc($filterRole) ?>">
														</div>
											...
											<!--begin::Export-->
											<button type="button" class="btn btn-light-primary me-3"
												onclick="window.location.href='<?= base_url('users/export') ?>?perPage=<?= $perPage ?>&filterName=<?= esc($filterName) ?>&filterEmail=<?= esc($filterEmail) ?>&filterPhone=<?= esc($filterPhone) ?>&filterRole=<?= esc($filterRole) ?>&page=<?= $pager->getCurrentPage() ?>'">
											...
											<!--begin::Add customer-->
											<a href="<?= base_url('users/create') ?>" class="btn btn-primary mb-3">Crear
												Usuario</a>
											<!--end::Add customer-->
										</div>
										<!--end::Toolbar-->
								...
								<div class="card-body pt-0">
									...
									<form method="get" action="<?= base_url('users') ?>"
										...
										<!-- Filtros existentes -->
										<input type="hidden" name="filterName" value="<?= esc($filterName) ?>">
										<input type="hidden" name="filterEmail" value="<?= esc($filterEmail) ?>">
										<input type="hidden" name="filterPhone" value="<?= esc($filterPhone) ?>">
										<input type="hidden" name="filterRole" value="<?= esc($filterRole) ?>">

										<label for="perPage" class="form-label me-2 text-primary">Usuarios por
											página:</label>
										<select name="perPage" id="perPage"
											class="form-select w-auto text-primary border-primary"
									...
									<?php if (!empty($usuarios) && is_array($usuarios)): ?>
										<table class="table table-bordered">
											<thead class="thead-dark">
												<tr>
													<th id="sortName">Nombre <span class="sort-icon"
															id="sortNameIcon">▲</span></th>
													<th id="sortEmail">Email <span class="sort-icon"
															id="sortEmailIcon">▲</span></th>
													<th id="sortPhone">Teléfono <span class="sort-icon"
															id="sortPhoneIcon">▲</span></th>
													<th id="sortRole">Rol <span class="sort-icon" id="sortRoleIcon">▲</span>
													</th>
													<th>Acciones</th>
												</tr>
											</thead>
											<tbody id="userTableBody">
												<?php foreach ($usuarios as $usuario): ?>
													<tr class="<?= $usuario['disabled'] == 1 ? 'table-danger' : '' ?>">
														<td class="text-dark"><?= esc($usuario['nombre']) ?></td>
														<td class="text-dark"><?= esc($usuario['email']) ?></td>
														<td class="text-dark"><?= esc($usuario['telefono']) ?></td>
														<td class="text-dark"><?= esc($usuario['rol']) ?></td>
														<td>
															<a href="<?= base_url('users/edit/' . $usuario['id']) ?>"
																class="btn btn-warning btn-sm">Editar</a>
															<?php if ($usuario['disabled'] == 0): ?>
																<a href="<?= base_url('users/deactivate/' . $usuario['id']) ?>"
																	class="btn btn-danger btn-sm"
																	onclick="return confirm('¿Estás seguro de dar de baja este usuario?');">Dar
																	de baja</a>
															<?php else: ?>
																<a href="<?= base_url('users/activate/' . $usuario['id']) ?>"
										...
										<script>
											document.addEventListener('DOMContentLoaded', function () {
												...
												function handleSortClick(event, columnIndex, iconId) {
												...
												document.getElementById('sortName').addEventListener('click', (event) => handleSortClick(event, 0, 'sortNameIcon'));
												document.getElementById('sortEmail').addEventListener('click', (event) => handleSortClick(event, 1, 'sortEmailIcon'));
												document.getElementById('sortPhone').addEventListener('click', (event) => handleSortClick(event, 2, 'sortPhoneIcon'));
												document.getElementById('sortRole').addEventListener('click', (event) => handleSortClick(event, 3, 'sortRoleIcon'));
											});
										</script>
									<?php else: ?>
												...
												<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll"
													...
													<div id="kt_modal_add_customer_billing_info" class="collapse show">
														...
														<div class="d-flex flex-column mb-7 fv-row">
															<!--begin::Label-->
															<label class="required fs-6 fw-bold mb-2">Address Line
																1</label>
															<!--end::Label-->
															<!--begin::Input-->
														...
														<div class="row g-9 mb-7">
															...
															<div class="col-md-6 fv-row">
																<!--begin::Label-->
																<label class="required fs-6 fw-bold mb-2">State /
																	Province</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input class="form-control form-control-solid"
															...
															<div class="col-md-6 fv-row">
																<!--begin::Label-->
																<label class="required fs-6 fw-bold mb-2">Post
																	Code</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input class="form-control form-control-solid"
					...
					<div
						...
						<div class="text-dark order-2 order-md-1">
							...
							<a href="https://keenthemes.com" target="_blank"
								class="text-gray-800 text-hover-primary">Javier Becerra Herrador</a>
						</div>
						<!--end::Copyright-->
						<!--begin::Menu-->
